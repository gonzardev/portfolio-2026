...
const translations = {
    en: {
        ...
        'projects.notes.title': 'Notes API with Authentication',
        'projects.notes.desc': 'RESTful API built with Django REST Framework for creating, managing, and sharing notes. Includes JWT authentication, user permissions, and full CRUD operations with PostgreSQL backend.',
    ...
    es: {
        ...
        'projects.notes.title': 'API de Notas con Autenticación',
        'projects.notes.desc': 'API RESTful construida con Django REST Framework. Incluye autenticación JWT, permisos de usuario y operaciones CRUD completas con backend PostgreSQL.',
