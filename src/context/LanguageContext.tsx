...
const translations = {
    en: {
        ...
        'projects.movie.title': 'GitPulse: AI Developer Insights',
        'projects.movie.desc': 'An analytics tool that leverages Artificial Intelligence to audit GitHub profiles. The system processes impact metrics (stars, activity, and repositories) to generate personalized mentorship and career advice through Large Language Models (LLMs).',
    ...
    es: {
        ...
        'projects.movie.title': 'GitPulse: AI Developer Insights',
        'projects.movie.desc': 'Herramienta de análisis que utiliza Inteligencia Artificial para auditar perfiles de GitHub. El sistema procesa métricas de impacto (estrellas, actividad y repositorios) para generar mentoría personalizada y consejos de carrera mediante modelos de lenguaje de gran escala.',
